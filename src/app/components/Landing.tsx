							...
							<div className="flex flex-col items-center justify-center space-y-4 text-center">
								<div className="space-y-2">
									...
									<p className="max-w-[900px] text-gray-800 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
										Our proprietary algorithm analyzes your gameplay data, skill level, and strategic preferences to
										pair you with the perfect opponents, ensuring thrilling and evenly matched competitions.
									</p>
								</div>
							</div>
										...
										<li>
											<div className="grid gap-1">
												...
												<p className="text-gray-800 dark:text-gray-400 text-lg">
													Our algorithm considers your unique playstyle and skill level to find the perfect opponents
													for you.
												</p>
											</div>
										</li>
